...
export class CodeReviewServiceImpl {
  ...
  private chatPrompt = ChatPromptTemplate.fromPromptMessages([
    ...
    Identify any potential bugs or security vulnerabilities. Check it adheres to the following coding standards and guidelines for both Java and Springboot:
